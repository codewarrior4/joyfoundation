                    ...
                    <div class="col-12">
                        <div class="tp-breadcumb-wrap">
                            ...
                            <ul>
                                ...
                                <li><span>Our Programmes</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 col-12">
                        <div class="about-content">
                            <div class="section-title">
                                <h2>ORPHAN’S MINISTRY </h2>
                            </div>
                            <p class="lead">We facilitate orphan care by supporting and partnering with orphanages across Nigeria. Our financial support helps the orphanages to provide quality care for the orphans. It also empowers them to take more orphans off the street.</p>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 col-12">
                        <div class="about-content">
                            <div class="section-title">
                                <h2>WIDOW’S EMPOWERMENT </h2>
                            </div>
                            <p class="lead">We empower widows to build financial sustenance, and create a positive future for themselves and their children.</p>
